...
def seafloor_friction(u_b,T_b,K_N,C_mu = 1):
...
def seafloor_stress(spec,fbins,h,K_N,C_mu=1,rho=1025):
    
    u_b,T_b = bed_velocity(spec,fbins,h)
    f_w = seafloor_friction(u_b,T_b,K_N,C_mu=C_mu)
